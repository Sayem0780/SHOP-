...
class Products with ChangeNotifier {
  ...
  Future<void> fectAndSetProduct([bool filterByUser = false]) async {
    ...
    var url = Uri.parse(
        'https://shop-624d0-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filterString');
    try {
      ...
      print("The loaded Product"+loadedProduct.length.toString());
  ...
  Future<void> addProduct(Product product) async {
    var Url = Uri.parse(
        'https://shop-624d0-default-rtdb.firebaseio.com/products.json?auth=$authToken');
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    final Url = Uri.parse(
        'https://shop-624d0-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken');
